...
savefig(p, "src/images/elastic_labor/Zshocks/irf_epsZ_e_stacked.pdf")  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_Z, [:M1, :M2, :M3, :M4, :M5, :M6, :M7, :M8, :M9]; horizon=75, ncols=3)
savefig(p, "src/images/elastic_labor/Zshocks/irf_epsZ_M_stacked.pdf")  # paper-ready PDF
...
savefig(p, "src/images/elastic_labor/Zshocks/irf_epsZ_rho_stacked.pdf")  # paper-ready PDF
...
p = plot_irfs_stacked(mr, :eps_Z, [:logL1, :logL2, :logL3, :logL4, :logL5, :logL6, :logL7, :logL8, :logL9]; horizon=75, ncols=3)
savefig(p, "src/images/elastic_labor/Zshocks/irf_epsZ_logL_stacked.pdf")  # paper-ready PDF
...
savefig(p, "src/images/elastic_labor/Xshocks/irf_epsX_e_stacked.pdf")  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:M1, :M2, :M3, :M4, :M5, :M6, :M7, :M8, :M9]; horizon=75, ncols=3)
savefig(p, "src/images/elastic_labor/Xshocks/irf_epsX_M_stacked.pdf")  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:logv1, :logv2, :logv3, :logv4, :logv5, :logv6, :logv7, :logv8, :logv9]; horizon=75, ncols=3)
savefig(p, "src/images/elastic_labor/Xshocks/irf_epsX_logv_stacked.pdf")  # paper-ready PDF
...
savefig(p, "src/images/elastic_labor/Xshocks/irf_epsZ_rho_stacked.pdf")  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:logl1, :logl2, :logl3, :logl4, :logl5, :logl6, :logl7, :logl8, :logl9]; horizon=75, ncols=3)
savefig(p, "src/images/elastic_labor/Xshocks/irf_epsZ_logl_stacked.pdf")  # paper-ready PDF
