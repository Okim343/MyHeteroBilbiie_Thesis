...
outdirZ = joinpath(@__DIR__, "..", "src", "images", "elastic_labor", "Zshocks")
mkpath(outdirZ)
...
savefig(p, joinpath(outdirZ,"irf_epsZ_e_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_Z, [:M1, :M2, :M3, :M4, :M5, :M6, :M7, :M8, :M9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirZ,"irf_epsZ_M_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_Z, [:logv1, :logv2, :logv3, :logv4, :logv5, :logv6, :logv7, :logv8, :logv9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirZ,"irf_epsZ_logv_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_Z, [:logy1, :logy2, :logy3, :logy4, :logy5, :logy6, :logy7, :logy8, :logy9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirZ,"irf_epsZ_logy_stacked.pdf")) # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_Z, [:logd1, :logd2, :logd3, :logd4, :logd5, :logd6, :logd7, :logd8, :logd9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirZ,"irf_epsZ_logd_stacked.pdf")) # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_Z, [:rho1, :rho2, :rho3, :rho4, :rho5, :rho6, :rho7, :rho8, :rho9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirZ,"irf_epsZ_rho_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_Z, [:logl1, :logl2, :logl3, :logl4, :logl5, :logl6, :logl7, :logl8, :logl9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirZ,"irf_epsZ_logl_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_Z, [:L1, :L2, :L3, :L4, :L5, :L6, :L7, :L8, :L9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirZ,"irf_epsZ_L_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_Z, [:logC1, :logC2, :logC3, :logC4, :logC5, :logC6, :logC7, :logC8, :logC9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirZ,"irf_epsZ_logC_stacked.pdf"))  # paper-ready PDF

# ─────────────────────Aggreagate investment shock X─────────────────────────────────────<

outdirX = joinpath(@__DIR__, "..", "src", "images", "elastic_labor", "Xshocks")
mkpath(outdirX)
...
savefig(p, joinpath(outdirX,"irf_epsX_e_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:M1, :M2, :M3, :M4, :M5, :M6, :M7, :M8, :M9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirX,"irf_epsX_M_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:logv1, :logv2, :logv3, :logv4, :logv5, :logv6, :logv7, :logv8, :logv9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirX,"irf_epsX_logv_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:logd1, :logd2, :logd3, :logd4, :logd5, :logd6, :logd7, :logd8, :logd9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirX,"irf_epsX_logd_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:logy1, :logy2, :logy3, :logy4, :logy5, :logy6, :logy7, :logy8, :logy9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirX,"irf_epsX_logy_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:rho1, :rho2, :rho3, :rho4, :rho5, :rho6, :rho7, :rho8, :rho9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirX,"irf_epsX_rho_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:logl1, :logl2, :logl3, :logl4, :logl5, :logl6, :logl7, :logl8, :logl9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirX,"irf_epsX_logl_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:L1, :L2, :L3, :L4, :L5, :L6, :L7, :L8, :L9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirX,"irf_epsX_L_stacked.pdf"))  # paper-ready PDF

p = plot_irfs_stacked(mr, :eps_X, [:logC1, :logC2, :logC3, :logC4, :logC5, :logC6, :logC7, :logC8, :logC9]; horizon=75, ncols=3)
savefig(p, joinpath(outdirX,"irf_epsX_logC_stacked.pdf"))  # paper-ready PDF