...
Interpreting the flow of prospective entrants $e_i$ as investment outlay, another insight about the model appears. Namely,
that Figure \ref{fig:steady-entry-log} can be re-read almost one-for-one as a sector-specific capital-production function $m_i = F_i(e_i)$.
