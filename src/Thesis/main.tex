...
\begin{equation}
  \text{MC}_{i,t} = \frac{w_t}{\alpha_i Z_t}\left(\frac{y_{i,t}}{Z_t}\right)^{\!1/\alpha_i-1},\label{eq:marginalcost}
\end{equation}
which, differently from BGM, are sector specific and depend directly on the returns-to-scale parameter $\alpha_i$.
With CES preferences, firms set relative prices as constant markups over marginal costs 
