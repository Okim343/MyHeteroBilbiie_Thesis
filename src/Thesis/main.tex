...
To address these questions, I integrate the seminal RBC with the endogenous entry framework found in \textcite{bilbiie2012endogenous} (henceforth BGM) 
...
specification. Their work laid a foundation for many subsequent DSGE models with entry, including applications to monetary policy (see e.g. \cite{bilbiie2007monetary,bergin2008extensive,etro2015new}) and 
