...
Heterogeneous scaling within startup cohorts also produces heterogeneous responses to macroeconomic shocks, giving rise to aggregate dynamics 
...
of \textcite{campbell1994inspecting} more clearly, where investment made in steady state acts as pure maintenance to keep the variety/firm stock from shrinking. Therefore,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Numerical Algorithm for Solving the Steady State}
...
smaller than $M_8$ for sector 8, despite the significantly higher value of $\alpha_9$, due to the extremely low steady-state probability of successful entry in 
$\Pi_9$ of around $0.2\%$\footnote{For quick reference, $\Pi_8$ is $1.3\%$ and $\Pi_7$ is $2.2\%$.}.
...
The figure puts the matching friction aspect of the model into the spotlight, showcasing the ``decreasing-returns-to-entry''
...
the matching probability at time $t$ for sector $i$, and that firms are now characterized by both $i$ and $\omega$.
Let the option value of waiting to enter for firm $\omega i$ be $\mathcal{W}_{i,t}(\omega)\ge0$. In all periods $t$,
\[
